...
## Identical to step 3-5 but including 300 YBP
...
## Input: out/mean/processed_sand_aat_tpr_prsd_300YBP.RData
## Dataframes for the five types of parameters estimated by the model
...
# Load formatted data
load('out/mean/processed_sand_aat_tpr_prsd_300YBP.RData')
