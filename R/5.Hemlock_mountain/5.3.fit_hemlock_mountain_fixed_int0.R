...
## Here, I fixed the intercept at zero, forcing the best fit
## lines to go through the origin
...
## Output: out/hemlock/out_small_hemlock_mountain_fixedint0.RData
...
## using the model with the fixed intercept at 0

## Output: out/hemlock/out_med_hemlock_mountain_fixedint0.RData
## Fitted model with parameter estimates, the data used to fit
## the model and the model code for a larger region
## surrounding the high hemlock abundance region of northern
## Wisconsin using the model with the fixed intercept at 0

## Output: out/hemlock/out_large_hemlock_mountain_fixedint0.RData
## Fitted model with parameter estimates, the data used to fit
## the model and the model code for an even larger region
## surrounding the high hemlock abundance region of northern
## Wisconsin. This includes grid cells within minimal spatial
## autocorrelation using the model with the fixed intercept at 0
...
data$int <- 0 # fixed intercept term
